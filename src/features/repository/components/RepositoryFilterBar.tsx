...
export function RepositoryFilterBar({
  ...
  return (
    <div className="mb-5 flex w-full flex-col gap-3 rounded-2xl border border-border bg-surface p-4 shadow-sm lg:flex-row lg:items-center lg:justify-between lg:gap-3">
      {/* Group 1: Pills & Search (Row 1 on tablet/laptop) */}
      <div className="flex w-full flex-col gap-3 md:flex-row md:items-center lg:w-auto lg:shrink-0 lg:gap-3">
        ...
        <div className="relative w-full md:flex-1 lg:w-56 lg:flex-none">
          <Search
            size={15}
      ...
      <div className={`grid w-full grid-cols-1 gap-3 ${gridColsClass} lg:flex lg:w-auto lg:flex-1 lg:items-center lg:justify-end lg:gap-3`}>
        <SelectField
          value={viewMode}
          onChange={(next) => onViewModeChange(next as RepositoryViewMode)}
          className="h-10 w-full rounded-xl border border-border bg-surface px-3.5 text-sm text-fg shadow-2xs outline-none transition hover:border-border-strong focus:border-primary focus:ring-4 focus:ring-primary/15 lg:w-44"
          options={[
        ...
        {hasFolders ? (
          <SelectField
            ...
            className="h-10 w-full rounded-xl border border-border bg-surface px-3.5 text-sm text-fg shadow-2xs outline-none transition hover:border-border-strong focus:border-primary focus:ring-4 focus:ring-primary/15 lg:w-40"
            options={[
